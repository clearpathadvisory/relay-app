    ...
    <main style={{ background: 'var(--base)', minHeight: '100vh' }}>
      <div className="shell">
        <header className="topbar">
          <span style={{ fontSize: 20, fontWeight: 800, letterSpacing: '-0.03em' }}>RelayMe</span>
          ...
          <section className="panel">
              ...
              <div>
                ...
                {!isPro && (
                  <div className="block block-bloom">
                    ...
                    <p className="bsub">47 themes, 8 fonts, your own colours, a background image, and no RelayMe badge. Try any of it now — you only pay to keep it.</p>
                    <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginTop: 14 }}>
            ...
            {tab === 'brand' && (
              <div>
                ...
                <div className="block block-plain">
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', flexWrap: 'wrap', gap: 8 }}>
                    <h2 className="bh">The RelayMe badge</h2>
                    {!isPro && <span className="prodot">Pro</span>}
                  </div>
                  <p className="bsub">
                    A small &ldquo;Join {page.username} on RelayMe&rdquo; button sits at the foot of your public
                  ...
                  <label className="switch">
                    ...
                    <span>Hide the RelayMe badge on my page</span>
                  </label>
                </div>
                ...
                {!isPro && (
                  <div className="block block-bloom">
                    ...
                    <p className="bsub">Fonts, colours, backgrounds and removing the RelayMe badge are part of Pro.</p>
                    <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginTop: 14 }}>
                  ...
                  {view.capture_on && (
                    <div style={{ marginTop: 16 }}>
                      ...
                      <p className="bsub" style={{ margin: '10px 0 0', fontSize: 13 }}>
                        ...
                        rather than to RelayMe, that we will check it is really them, and how to leave.
              ...
              <div className="block block-violet">
                ...
                {qr && (
                  <div style={{ marginTop: 20, textAlign: 'center' }}>
                    <img src={qr} alt="QR code for your RelayMe page" style={{ width: 200, height: 200, borderRadius: 16 }} />
            ...
            {tab === 'share' && (
              <div className="block block-plain">
                ...
                <div className="serp">
                  ...
                  <p className="serptitle">{(seoTitle || page.display_name || page.username) + ' — RelayMe'}</p>
